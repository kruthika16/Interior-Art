...
$result = mysqli_query($conn,$query);
    echo "<table border='1'><tr><th>Product ID</th><th>Quantity</th><th> Total Price</th></tr>";
...
if(isset($_POST['submit']))
  echo '<meta http-equiv="refresh" content="0;URL=/order.html" />';
mysqli_close($conn);
}
 ...
 ?>
 <form><input type="submit" name="submit" value="Confirm order and Buy"> </form>
