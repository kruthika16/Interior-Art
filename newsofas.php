...
<html>
<head>
<title>Interior Art | Sofas&Seating</title>
...
<div class="tail-bottom">
  ...
  <div id="header">
    ...
    <div class="row-2">
      <ul>
        <li><a href="newsofas.php" class="active">Sofas & Seating</a></li>
				...
				<link href="grid-style.css" rel="stylesheet" type="text/css" />
				 <div class="grid">
					...
					<br><br>
						...
						<p>Robins Lounge Chair(Aqu)     Rs.7499/-<br>PRODUCT ID: s1</p><br><br></div>
						...
						<p>Appolo letherette sofa (chocolate)     Rs.37999/-<br>PRODUCT ID: s3</p><br></div>
